export default function Hero() {
    return (
        <section className="relative overflow-hidden pt-20 lg:pt-12">
            <figure className="absolute top-1/2 left-0 -translate-y-1/2 -ms-7 hidden 2xl:block">
                <svg className="rotate-[74deg] fill-red-600 opacity-100">
            ...
            <span className="absolute top-1/2 right-0 translate-y-1/2 mt-5 -me-5 hidden 2xl:inline-flex">
                <svg className="fill-yellow-400 rotate-[186deg] opacity-80">
            ...
            <div>
                <div>
                    <div className="lg:col-span-5 xl:col-span-6 relative z-[1] text-center lg:text-left mb-5 sm:mb-0">
                        <figure className="fill-yellow-400 absolute bottom-0 right-0 me-5 hidden xl:block">
                        ...
                        <figure className="fill-green-500 absolute top-0 left-1/2 -translate-x-1/2 -mt-5 ml-5">
                        ...
                        <h1 className="mb-0 text-4xl sm:text-5xl font-bold">
                            Limitless learning at your
                            <span className="relative inline-block">
                                fingertips
                                <span className="absolute top-1/2 left-1/2 -translate-x-1/2 ml-3 z-[-1]">
                                    <svg width="300" height="62" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
                                        <path className="fill-yellow-400" d="..."></path>
                                    </svg>
                                </span>
                            </span>
                        </h1>
                        ...
                        <ul className="flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-2 mb-4 text-sm text-gray-700">
                            <li className="flex items-center"><i className="bi bi-patch-check-fill mr-1 text-yellow-500"></i>Learn with experts</li>
                            <li className="flex items-center"><i className="bi bi-patch-check-fill mr-1 text-yellow-500"></i>Get certificate</li>
                            <li className="flex items-center"><i className="bi bi-patch-check-fill mr-1 text-yellow-500"></i>Get membership</li>
                        </ul>

                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                            <a href="#" className="btn btn-lg bg-red-100 text-red-700 hover:bg-red-200 px-6 py-3 rounded-md shadow-sm">
                                Get Started
                            </a>

                            <a href="https://www.youtube.com/embed/tXHviS-4ygo" data-glightbox data-gallery="office-tour" className="flex items-center space-x-3">
                                <div className="bg-blue-500 text-white rounded-full w-10 h-10 flex items-center justify-center shadow-md">
                                    <i className="fas fa-play"></i>
                                </div>
                                <div>
                                    <h6 className="text-base font-medium">Watch video</h6>
                                </div>
                            </a>
                        </div>
                    </div>
